    ...
    <div className={`min-h-screen bg-[#050507] text-white overflow-x-hidden selection:bg-[#00ffff] selection:text-black pb-24 md:pb-0 ${hindSiliguri.variable}`} style={{ fontFamily: 'var(--font-space-grotesk), var(--font-hind-siliguri), sans-serif' }}>
      ...
      <section className="relative z-10 flex flex-col items-center px-4 sm:px-6 pt-20 sm:pt-28 pb-10 sm:pb-16 text-center">
        ...
        <motion.p
          ...
          className="max-w-2xl text-white/60 text-sm sm:text-lg leading-relaxed mb-6 sm:mb-8 font-light px-1"
        >
        ...
        <motion.div
          ...
          className="flex flex-col sm:flex-row gap-3 sm:gap-4 items-stretch sm:items-center w-full max-w-md sm:max-w-none sm:w-auto mb-8 sm:mb-10"
        >
          <a
            href="#register"
            className="px-8 py-4 rounded-full bg-[#00ffff] text-black font-bold uppercase tracking-wide shadow-[0_0_30px_rgba(0,255,255,0.3)] hover:shadow-[0_0_40px_rgba(0,255,255,0.6)] hover:scale-[1.02] transition-all duration-300 text-sm cursor-pointer text-center"
          >
            রেজিস্ট্রেশন করুন — ২০০০৳
          </a>
          <a
            href="#questions"
            className="px-8 py-4 rounded-full border border-white/10 bg-white/5 text-white/80 font-bold uppercase tracking-wide hover:border-white/30 hover:text-white hover:bg-white/10 transition-all duration-300 text-sm cursor-pointer text-center"
          >
            আলোচ্য বিষয়সমূহ
          </a>
        </motion.div>
        ...
        >
          <div className="flex flex-col text-left">
            ...
            <span className="text-white/50 text-[10px] uppercase tracking-wide font-bold mt-1">Special Discount Fee</span>
          </div>
          <div className="h-10 w-px bg-[#00ffff]/20" />
          <p className="text-white/70 text-xs sm:text-sm text-left leading-snug font-medium">
            <span className="text-white font-bold">সীমিত সিট!</span> কোর্স শুরু হতে <br className="hidden sm:block" />আর অল্প কিছুদিন বাকি।
          </p>
        </motion.div>
      ...
      <footer className="relative z-10 border-t border-white/10 px-6 py-10 bg-[#050507]">
        <div className="max-w-7xl mx-auto flex flex-col sm:flex-row items-center justify-between gap-4 text-center sm:text-left">
          ...
          <div className="flex flex-col sm:flex-row items-center gap-3 sm:gap-6 text-xs text-white/50">
            ...
            <a
              href="https://wa.me/8801834473283"
              target="_blank"
              rel="noopener noreferrer"
            ...
            <a href="mailto:nanographic.info01@gmail.com" className="hover:text-[#00ffff] transition-colors">
